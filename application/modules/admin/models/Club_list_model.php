...
class Club_list_model extends CI_Model {

    //var $table , $column_order, $column_search , $order =  '';
    var $table = CLUBS;
    var $column_order = array('clubId','club_email','club_image','club_name','c.status','cc.club_category_name'); //set column field database for datatable orderable
    var $column_search = array('club_name'); //set column field database for datatable searchable
    var $order = array('clubId' => 'DESC');  // default order
    var $where = '';
